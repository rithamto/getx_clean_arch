...
''';
  ...
  static String androidAppBuildGradleKts(
    String namespace,
...
android {
    ...
    defaultConfig {
        ...
        setProperty("archivesBaseName", "${applicationId.split('.').last}_\$versionName+\$versionCode")
    }
...
''';
  ...
  static String get androidSettingsGradleKts => '''
pluginManagement {
    val flutterSdkPath =
        run {
